...
INC 				:= -I./ui/simulator/inc/ -I./ -I./lvgl/ -I/usr/local/Cellar/sdl2/2.30.8/include#-I/usr/include/freetype2 -L/usr/local/lib
# LDLIBS	 			:= -l$(LV_DRIVER) -lpthread -lm #-lfreetype -lavformat -lavcodec -lavutil -lswscale -lm -lz
LDLIBS	 			:= -lm -L /usr/local/Cellar/sdl2/2.30.8/lib -l SDL2
BIN 				:= $(BIN_DIR)/demo
